...
public class OrderServiceImpl implements OrderService {
    ...
    public void paySuccess(String outTradeNo) {
        ...
        //通过websocket向客户端推送消息数据 type orderId content
        Map map = new HashMap();
        map.put("type", 1);//1表示来单提醒，二表示客户催单
     ...
     * @return
     */
    public void rejction(OrdersRejectionDTO ordersRejectionDTO) {
        //只有待接单才能够拒单，与接单一样修改状态
        //需要告知拒单原因
        //根据id查询订单
    ...
    public void reminder(Long id) {
        ...
        //通过websocket向客户端推送消息数据 type orderId content
        Map map = new HashMap();
        map.put("type", 2);//1表示来单提醒，二表示客户催单
        map.put("orderId", ordersDB.getId());
